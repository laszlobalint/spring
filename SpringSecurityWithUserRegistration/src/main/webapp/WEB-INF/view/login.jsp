...
<html lang="en">
  ...
  <body>
    <div id="loginbox" style="margin-top: 50px" class="mainbox col-md-3 col-md-offset-2 col-sm-6 col-sm-offset-2">
              ...
              <div class="col-xs-15">
                <div>
                  <c:if test="${param.error != null}">
                    <div class="alert alert-danger col-xs-offset-1 col-xs-10">Invalid user name or password.</div>
                  </c:if>
      ...
      <div>
  	    <a href="${pageContext.request.contextPath}/register/show-form" class="btn btn-primary" role="button" aria-pressed="true">Register New User</a>
	  </div>
    </div>
  </body>
</html>
